...
def test__load_featurizer_params_method_when_vocab_is_not_None_therefore__check_if_stored_vocabulary_exists_and_load_it_method_is_called_with_True_expected_call_correct_methods(
    get_CountVecFeaturizer_instance_for_testing,
    get_dummy_dict_vocab_for_testing,
    mocker
):
...
def test__load_featurizer_params_method_when_vocab_is_None_therefore__check_if_stored_vocabulary_exists_and_load_it_method_is_called_with_False_expected_call_correct_methods(
    get_CountVecFeaturizer_instance_for_testing,
    mocker
):
    featurizer = get_CountVecFeaturizer_instance_for_testing
